...
### Release 2.14.11 (August 31, 2017)

- [#5131](https://github.com/emberjs/data/pull/5131) {Backport release} [BUGFIX release] Failing test for #5125 and attempted fix
- [#5146](https://github.com/emberjs/data/pull/5146) {backport release} [BUGFIX release] Load many2many relationships correctly
- [#5149](https://github.com/emberjs/data/pull/5149) {backport release} [BUGFIX release] fix relationship merging
- [#5152](https://github.com/emberjs/data/pull/5152) Backport `ember-inflector` imports
- [#5154](https://github.com/emberjs/data/pull/5154) {release} Release has many sync
